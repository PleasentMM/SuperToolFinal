...
public class CircleTimerView extends View {
    ...
    // Default color
    private static final int DEFAULT_CIRCLE_COLOR = 0xFFFF4081;
    private static final int DEFAULT_CIRCLE_BUTTON_COLOR = 0xFFff0008;
    private static final int DEFAULT_LINE_COLOR = 0xFFFF4081;
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = 0xFF0008ff;
